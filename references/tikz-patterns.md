...
- Export to PDF for vector quality; compile-check with your TeX engine (tectonic, TeX Live, MiKTeX, or MacTeX) via `scripts/latex-compile.py`, which uses whichever engine you have installed (`--engine` / `LATEX_ENGINE` to pick one explicitly)
