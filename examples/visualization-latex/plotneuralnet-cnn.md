...
Self-contained `.tex` (all layer macros inlined, no `import` of external PlotNeuralNet files). Compiles with `tectonic plotneuralnet-cnn.tex`. Verified: compiled on 2026-07-12.
