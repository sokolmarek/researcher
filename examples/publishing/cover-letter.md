...
Compiles with `tectonic cover-letter.tex` using the `letter` class. Verified: compiled on 2026-07-12.
...
- Facts (title, journal, method, data availability) are consistent with the manuscript-setup, drafting, and journal-finder examples, and the file compiles with tectonic.
