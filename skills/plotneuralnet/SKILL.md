...
Every generated `.tex` file is a single standalone document. All layer macros, color definitions, and style commands are embedded directly in the file preamble. The file compiles with tectonic (or any standard LaTeX distribution) without additional files.
